...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='http://goo.gl/rKJWvA' target='_blank'><img src='' width='500px'/><br/>Căn Hộ PMH </a>. Chủ Đầu Tư PMH. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
